...
>
    ...
    <Pressable onPress={toggleModal} style={{width:60,height:60,borderRadius:40,justifyContent:'center',backgroundColor:'black',marginLeft:'auto',position:'absolute',bottom:35,right:25,alignContent:'center'}}>
    ...
    {total === 0 ? null : (
      <Pressable  style={{backgroundColor:'#00A877',width:"90%",padding:13,marginLeft:'auto',marginRight:'auto',marginBottom:30,position:'absolute',borderRadius:8,left:20,bottom:10,}}>
        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
          <View>
          <Text style={{fontSize:16,fontWeight:'bold',color:'white'}}>{cart.length} items | {total}</Text>
